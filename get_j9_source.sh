...
usage() {
	...
	echo "                    or git@github.com:bragaigor/omr.git"
...
git_urls[openj9]=https://github.com/bragaigor/openj9
branches[openj9]=contiguous

git_urls[omr]=https://github.com/bragaigor/omr
branches[omr]=contiguous
